...
*   [`guides/github-copilot-edits-use-case-guide.md`](guides/github-copilot-edits-use-case-guide.md): A guide on using GitHub Copilot Edits (specifically Agent Mode) for generating comprehensive test coverage for Java applications. It outlines a phased approach (20%, 50%, 80% coverage) with prompt templates and best practices for context management and troubleshooting.
